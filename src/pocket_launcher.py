...
def parse_args(args):
    ...
    parser.add_argument(
        "--favorite", dest="favorite", action="store_true", default=None
    )
    parser.add_argument("--delete", dest="delete", action="store_true", default=None)
    parser.add_argument("--website", dest="website", action="store_true", default=None)
...
def open_alfred():
    os.system(
        'osascript -e \'tell application "Alfred 3" to run trigger '
